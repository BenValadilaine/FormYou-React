			...
			<Modal show={show} onHide={handleClose}>
				...
				<Modal.Body>
					<form onSubmit={editFormation}>
						...
						<input name="formation-title" type="text" placeholder="Nouveau titre" /><br />
						<textarea name="formation-description" placeholder="Nouvelle description" /><br />
						<hr />
						...
						<fieldset>      
							...
							{categories.map((category) => (
								<>
									<label for="categories-select">{category.name}</label><br />
									<input type="checkbox" name="categories-select" value={category.id}/><br />
								</>
							))}                  
						</fieldset><br />  
